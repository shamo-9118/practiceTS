...
const styles = [
  {
    bg: 'bg-gray-300',
    hover:
      'hover:bg-gray-800 shadow hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,5)]',
  ...
  },
  {
    ...
    hover:
      'hover:shadow-none hover:translate-y-[2px] hover:translate-x-[2px] hover:font-normal',
    id: 2,
  },
  {
  ...
  //擬似要素使3のボタンを実装した
  {
    ...
    before:
      'before:bg-gray-200 before:w-full before:h-full before:absolute before:top-0 before:left-0 before:-translate-x-[49%] before:skew-x-12 before:duration:500 before:-z-10 before:group-hover:-translate-x-[120%]',
    after:
      'after:bg-gray-200 after:w-full after:h-full after:absolute after:top-0 after:right-0 after:translate-x-[49%] after:skew-x-12 before:group-hover:-translate-x-[120%] after:duration-500 after:z-20',
    id: 4,
  },
  {
    after:
      'after:absolute after:bg-gray-300 after:w-[110%] after:h-full after:top-0 after:-left-4 after:skew-x-[25deg] after:duration-300 after:scale-x-0 hover:after:scale-x-100',
    id: 5,
  },
]
      ...
      {styles.map((style) => {
        {
          if (style.id === 3) {
            ...
            return (
              ...
              >
                <span className='relative z-20 left-0 top-0 '>button</span>
              </button>
            )
          } else {
            return (
